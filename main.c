...
void test_copyIf_1_digit_copying() {
    ...
    char destination[50];
    char *result = copyIf(str, str + strlen_(str), destination, isdigit);
...
void test_copyIf_2_letter_copying() {
    char *str = "Hello123World456";
    char destination[50];
    char *result = copyIf(str, str + strlen_(str), destination, isalpha);
...
void test_copyIfReverse_1_digit_copying(){
    ...
    char *result = copyIfReverse(str + strlen_(str) - 1, str - 1, destination, isalpha);
...
void test_copyIfReverse_2_letter_copying(){
    char *str = "341224abcde";
    char destination[50] = {0};
    char *result = copyIfReverse(str + strlen_(str) - 1, str - 1, destination, isdigit);
